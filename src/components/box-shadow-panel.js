        ...
        return (
          <div key={index}>
            ...
            <div className="control-panel-action-group">
              {enabled
                ? <Button style={{ float: 'left' }} icon="eye-off" minimal onClick={onEnableShadow.bind(this, index)}></Button>
                : <Button style={{ float: 'left' }} icon="eye-on" minimal onClick={onDisableShadow.bind(this, index)}></Button>
              }
